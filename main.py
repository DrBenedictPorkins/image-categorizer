    ...
    summary_html = f"""<div class="summary">
        <div class="summary-content">
            <div class="summary-main">
                ...
                <p class="summary-description">AI-powered image categorization using BLIP for descriptions and Claude 3.7 Sonnet for intelligent categorization. Images are analyzed and sorted into logical categories based on their content.</p>
            </div>"""
...
def main(directory: str, json_file: str = None) -> None:
    ...
    print("Loading Salesforce BLIP-2 model with prompt support...")
    try:
